...
INSERT INTO bike_data (engineCapacity, weight) VALUES
                                                   (600.0, 150.5),
                                                   (1000.0, 190.3),
                                                   (800.0, 175.0);

-- Inserir dades per a la taula 'bikes'
INSERT INTO bikes (model, year, bike_data_id, brand_id) VALUES
                                                            ('YZF-R6', 2020, 1, 1),  -- Model de Yamaha, BikeData 1, Brand Yamaha
                                                            ('CBR1000RR', 2021, 2, 2),  -- Model de Honda, BikeData 2, Brand Honda
                                                            ('Panigale V4', 2022, 3, 3);  -- Model de Ducati, BikeData 3, Brand Ducati
